...
import {
  ...
  SaveButton,
  ImageUpload,
} from "@/src/app/vendor/settings/(components)/UI";
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4">
          ...
          <Field label="Instagram handle">
            <div className="flex">
              <span
                className="inline-flex items-center px-3 rounded-l-xl border border-r-0
                border-gray-200 bg-gray-50 text-xs text-gray-500 font-medium"
              >
                instagram.com/
              </span>
              <input
        ...
        {/* ── QR Code section ── */}
        <QRSection storeSlug={store.storeSlug} storeName={store.storeName} />
