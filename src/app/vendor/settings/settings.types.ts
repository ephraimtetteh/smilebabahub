// src/app/vendor/settings/settings-types.ts
// Runtime values (TABS, formatBytes) + local types (Tab, VideoFile, TabConfig)
// that are specific to the vendor settings feature.
//
// Pure user/app-wide types (UserProp, UserRole, etc.) live in src/types/types.d.ts
