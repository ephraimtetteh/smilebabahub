...
// Lucide icon per plan — ReactNode, not string
const PLAN_ICONS: Record<string, React.ReactNode> = {
  Basic: <Smile size={18} className="text-green-600" />,
  standard: <Zap size={18} className="text-blue-600" />,
  popular: <Star size={18} className="text-yellow-500 fill-yellow-400" />,
  premium: <Crown size={18} className="text-purple-600" />,
};
...
export default function PurchaseHistoryPage() {
  ...
  const { currency, sym } = useViewCountry();
