...
export default function NewVideo() {
  ...
  // Video stream URL — configure via NEXT_PUBLIC_VIDEO_STREAM_URL
  const STREAM_URL =
    process.env.NEXT_PUBLIC_VIDEO_STREAM_URL ??
    "https://media2.streambrothers.com:2000/public/80563u8";
  ...
  useEffect(() => {
    ...
    if (Hls.isSupported()) {
      ...
      hls.on(Hls.Events.ERROR, (_evt: any, data: any) => {
        if (data.fatal) {
          console.warn("[Video] HLS fatal error — stream may be offline");
        }
      });
