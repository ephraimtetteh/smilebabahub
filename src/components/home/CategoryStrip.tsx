...
const SHORTCUTS: Shortcut[] = [
  {
    ...
    icon: Car,
    color: "text-blue-500",
    href: "/ads?category=marketplace&q=car",
  },
  {
    label: "Property",
    icon: Home,
        ...
        {SHORTCUTS.map((s) => {
          ...
          return (
            <Link
              key={s.label}
              href={s.href}
              className="flex flex-col items-center rounded-xl border border-gray-100 bg-white px-1 py-3 transition hover:border-gray-200 hover:shadow-sm"
            >
