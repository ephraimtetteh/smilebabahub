...
const AddProduct = ({image, name, brand, inventory, price, sales, status, title, action}: AddProductOrderProps) => {
  return (
    <div className="flex flex-col ">
      ...
      <div className="grid grid-cols-6 items-center justify-between text-gray-700 border-b border-gray-200 py-2">
        ...
        <div className={`bg-black/10 p-2 rounded border-white/20 text-[12px] shadow-sm w-fit ${statuVariantStyle(status)}`}>
